@extends('layouts.app', ['activePage' => 'add-driver', 'titlePage' => __('Add Vehicle Information')])
                    ...
                    <form method="post" action="{{ route('vehicle.store') }}" autocomplete="off" class="form-horizontal">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="alert alert-danger">
                                            ...
                                            <span>The vehicle for driver has already been registered.</span>
                                        </div>
                                    </div>
                                </div>
                                @endif
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('vehicle_no') ? ' has-danger' : '' }}">
                                            <input
                                                ...
                                                placeholder="{{ __('XX-X-AB-XXXX') }}" value="{{ old('vehicle_no') }}"
                                ...
                                <input class="form-control" name="id" id="id" type="hidden" value="{{ $driver_id }}"
                                    required />
                                <div class="row">
                                    ...
                                    <div class="col-sm-7 col-form-label">
                                        <select id="inputState" class="form-control" name="vehicle_type" required>
                                            ...
                                            @foreach ($vehicle_types as $vt)
                                                <option value="{{ $vt->id }}"
                                                    {{ old('vehicle_type') == $vt->id ? 'selected' : '' }}>

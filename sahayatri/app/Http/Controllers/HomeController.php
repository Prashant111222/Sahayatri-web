...
class HomeController extends Controller
{
    ...
    public function getDailyIncomeData($day){
        ...
        ->whereDay('updated_at', Carbon::now()->subWeek()->startOfWeek(Carbon::SUNDAY)->addWeekDays($day))
    ...
    public function getDailyDistanceData($day){
        ...
        ->whereDay('rides.updated_at', Carbon::now()->subWeek()->startOfWeek(Carbon::SUNDAY)->addWeekDays($day))
        ->where('rides.status', 'completed')
        ->groupBy('date')
        ->first();
    }
    ...
    public function getDailyUsersData($day){
        ...
        ->whereDay('created_at', Carbon::now()->subWeek()->startOfWeek(Carbon::SUNDAY)->addWeekDays($day))
        ->where('type', 'client')
        ->groupBy('date')
        ->first();
    }

...
class HomeController extends Controller
{
    ...
    public function getDailyIncomeData($day){
        ...
        ->whereDay('updated_at', Carbon::now()->subWeek()->startOfWeek(Carbon::SUNDAY)->addWeekDays($day - 50))
    ...
    public function getDailyDistanceData($day){
        ...
        ->whereDay('rides.updated_at', Carbon::now()->subWeek()->startOfWeek(Carbon::SUNDAY)->addWeekDays($day - 50))
        ->where('rides.status', 'completed')
        ->groupBy('date')
        ->first();
    }
    ...
    public function getDailyUsersData($day){
        ...
        ->whereDay('created_at', Carbon::now()->subWeek()->startOfWeek(Carbon::SUNDAY)->addWeekDays($day - 50))
        ->where('type', 'client')
        ->groupBy('date')
        ->first();
    }

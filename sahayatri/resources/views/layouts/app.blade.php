...
<head>
    ...
    <title>{{ __('Saha-Yatri') }}</title>
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('material') }}/img/sahayatri.png">
    <link rel="icon" type="image/png" href="{{ asset('material') }}/img/sahayatri.png">
    ...
    <link href="{{ asset('material') }}/css/datatable.css" rel="stylesheet" />
...
<body class="{{ $class ?? '' }}">
                    ...
                    <li class="adjustments-line">
                        <a href="javascript:void(0)" class="switch-trigger active-color">
                            <div class="badge-colors ml-auto mr-auto">
                                <span class="badge filter badge-purple " data-color="pink"></span>
                            </div>
    ...
    <script src="{{ asset('material') }}/js/datatable.js"></script>
    @stack('js')
</body>
